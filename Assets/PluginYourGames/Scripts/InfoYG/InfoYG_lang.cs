...
namespace YG.Insides
{
    public static partial class Langs
    {
        ...
        public const string t_editTimeScale = "Когда опция включена, во время паузы будет производиться остановка игрового времени.";
        ...
        public const string t_editTimeScale = "When this option is enabled, the game time will be stopped during the pause.";
