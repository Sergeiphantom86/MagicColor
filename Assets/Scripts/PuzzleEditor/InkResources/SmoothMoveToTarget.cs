...
namespace PuzzleEditor.InkResources
{
    ...
    {
        private const float DeleyBeforePlacingOrder = 1;
        ...
        private WaitForSeconds _waitBeforePlacingOrder;
        private Drop _drop;
        ...
        private void Awake()
        {
            ...
            _waitBeforePlacingOrder = new WaitForSeconds(DeleyBeforePlacingOrder);
        }
        ...
        {
            yield return _waitBeforePlacingOrder;
