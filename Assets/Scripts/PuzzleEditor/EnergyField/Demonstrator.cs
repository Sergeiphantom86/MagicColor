...
namespace PuzzleEditor.EnergyField
{
    ...
    public class Demonstrator : MonoBehaviour
    {
        ...
        [SerializeField]
        private MagicSphere _magicSphere;
        ...
        private void StartPulsation()
        {
            ...
            _pulseTween = DOTween
                .To(
                    ...
                    time =>
                    {
                        _scaleMultiplier = GetConfirmatTimeChange(time, _scaleBoostThreshold)
                            ? _scaleMultiplier
                            : _boostedScaleMultiplier;
                        ...
                        float alpha = GetConfirmatTimeChange(time, _timeDivider)
                            ? GetMaxAlpha(0, _maxAlpha, time)
                            : GetMaxAlpha(_maxAlpha, 0, time - _alphaPeakTime);
