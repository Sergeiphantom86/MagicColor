...
namespace PuzzleEditor.MovingBlocks.GridEditor
{
    ...
    public class GridDragMovement : MonoBehaviour
    {
        ...
        private void TryShift()
        {
            ...
            Vector2Int targetOrigin = _grid.GetOriginFromCenter(targetCenter, _block.SizeInCells);
        ...
        private void MoveTo(Vector2Int targetCenter)
        {
            ...
            Vector2Int origin = _grid.GetOriginFromCenter(targetCenter, _block.SizeInCells);
